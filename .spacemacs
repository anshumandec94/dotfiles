...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(sql
     ...
     version-control
     treemacs
     (org :variables org-enable-babel-support t)
   ...
   dotspacemacs-additional-packages '(copilot-chat evil-surround uv-mode)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(live-py-mode)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Prevent the Python layer from trying to bind = = by telling it
  ;; we don't want format-on-save or any = bindings
  )


(defun dotspacemacs/user-load ()
  "Library to load while dumping. fs
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link afternoon-theme aggressive-indent alect-themes all-the-icons
                ...
                madhat2r-theme markdown-toc material-theme minimal-theme moe-theme
                ...
                org-rich-yank org-superstar organic-green-theme orgit-forge
                origami overseer page-break-lines paradox password-generator
                pcre2el phoenix-dark-mono-theme phoenix-dark-pink-theme
                pip-requirements pipenv pippel planet-theme poetry popwin
                prettier-js professional-theme purple-haze-theme py-isort pydoc
